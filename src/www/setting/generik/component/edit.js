...
export default class EditModal extends React.Component {
    ...
    showModalEdit = async (data) => {
        let result = await API.viewGenerik(data.original.id);
    ...
    editBranch(id) {
        ...
        return new Promise((resolve, reject) => {
            fetch(global.ipServer + 'setting/updateJawatanGenerik', {
                method: 'PUT',
                body: formData,
                headers: {
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="text"
                                               name={'kod'}
                                               value={this.state.modalData.kod}
                                               onChange={(dataEl) => {
                                                   this.state.modalData.kod = dataEl.target.value;
