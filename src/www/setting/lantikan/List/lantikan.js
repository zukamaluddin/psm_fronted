...
export default class ListLantikan extends React.Component {
    selectedDataAssign = [];
    constructor(props) {
        super(props);
        this.state = {
    ...
    loadData = async () => {
        let result = await API.listLantikan(this.state.set);
        this.setState({
            data: result.data,
                ...
                <CardBody>
                    <div>
                        <Button style={{width: '140px'}}
                                onClick={() => {
                                    this.props.history.push('/setting/registerLantikan');
                                    setTimeout(function () {
                                        settingMenu.changeActiveLinkTo('#/setting/registerLantikan');
                                    }.bind(this),);
                                }}
