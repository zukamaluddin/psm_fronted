...
export default class SerapanList extends React.Component {
    ...
    exportExcelFile = (workbook) => {
        return XLSX.writeFile(workbook, 'Laporan ' + this.props.searchQuery.tahun + '.xlsx');
    };
            ...
            <ReactCSSTransitionGroup
                ...
                <Card className="main-card mb-3">
                    <CardBody>
                        ...
                        >
                            <Row>
                                <Col md={12}><b>Laporan Jumlah Penentusahan
                                    {/*Oleh&nbsp;*/}
                                    {/*{this.props.searchQuery.pembaik === 'Semua' ? 'Semua Pembaik' : this.props.searchQuery.pembaik} dan&nbsp;*/}
                                    {/*{this.props.searchQuery.cawangan === 'Semua' ? 'Semua Cawangan' : 'Cawangan' + this.props.searchQuery.cawangan} pada&nbsp;*/}
                                    {/*{this.props.searchQuery.bulan === 'Semua' ? '' : this.props.searchQuery.bulan} &nbsp;*/}
                                    {/*{this.props.searchQuery.tahun}*/}
                                </b></Col>
                                <Col>
